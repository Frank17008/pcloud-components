...
1. 安装组件后, 为什么项目中的 antd 组件都是英文的？
   ...
   - 这是因为 antd 的默认语言是英文，项目启动时，会自动加载中文语言包，如果项目需要使用英文，请自行在项目入口处导入英文语言包, 并使用 ConfigProvider 组件注入.

2. 项目安装的是 antd5 的版本, 能使用组件吗？

   - 此组件库基于 antd 4.24.16 开发，antd5 的版本暂时不兼容，请使用 antd4.x 版本, 后续会升级到 antd5 版本
