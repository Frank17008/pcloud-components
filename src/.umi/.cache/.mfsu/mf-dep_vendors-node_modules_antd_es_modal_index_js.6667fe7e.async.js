...
var Portal = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.forwardRef(function (props, ref) {
  ...
  (0,_useScrollLocker__WEBPACK_IMPORTED_MODULE_8__.default)(autoLock && open && (0,rc_util_es_Dom_canUseDom__WEBPACK_IMPORTED_MODULE_3__.default)() && (mergedContainer === defaultContainer || mergedContainer === document.body)); // =========================== Ref ===========================
  ...
  var mergedRef = (0,rc_util_es_ref__WEBPACK_IMPORTED_MODULE_5__.useComposeRef)(childRef, ref); // ========================= Render ==========================
...
function confirm(config) {
  ...
  function destroy() {
    ...
    for (var i = 0; i < _destroyFns__WEBPACK_IMPORTED_MODULE_4__.default.length; i++) {
      var fn = _destroyFns__WEBPACK_IMPORTED_MODULE_4__.default[i]; // eslint-disable-next-line @typescript-eslint/no-use-before-define
