(self["webpackChunk_pointcloud_pcloud_components"] = self["webpackChunk_pointcloud_pcloud_components"] || []).push([["mf-dep_vendors-node_modules_framer-motion_dist_es_index_mjs"],{
...
/* harmony import */ var _render_utils_setters_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../render/utils/setters.mjs */ "./node_modules/framer-motion/dist/es/render/utils/setters.mjs");
/* harmony import */ var _render_index_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../render/index.mjs */ "./node_modules/framer-motion/dist/es/render/index.mjs");
/* harmony import */ var _render_utils_animation_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../render/utils/animation.mjs */ "./node_modules/framer-motion/dist/es/render/utils/animation.mjs");
/* harmony import */ var _motion_utils_use_visual_state_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../motion/utils/use-visual-state.mjs */ "./node_modules/framer-motion/dist/es/motion/utils/use-visual-state.mjs");
...
var stateVisualElement = (0,_render_index_mjs__WEBPACK_IMPORTED_MODULE_1__.visualElement)({
  build: function build() {},
  measureViewportBox: _projection_geometry_models_mjs__WEBPACK_IMPORTED_MODULE_2__.createBox,
  ...
  makeTargetAnimatable: function makeTargetAnimatable(element, _a) {
    var transition = _a.transition,
        ...
        target = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__rest)(_a, ["transition", "transitionEnd"]);

    var origin = (0,_render_utils_setters_mjs__WEBPACK_IMPORTED_MODULE_4__.getOrigin)(target, transition || {}, element);
    (0,_render_utils_setters_mjs__WEBPACK_IMPORTED_MODULE_4__.checkTargetForNewValues)(element, target, origin);
    return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({
      transition: transition,
      transitionEnd: transitionEnd
    }, target);
  }
});
var useVisualState = (0,_motion_utils_use_visual_state_mjs__WEBPACK_IMPORTED_MODULE_5__.makeUseVisualState)({
  scrapeMotionValuesFromProps: createObject,
...
function useAnimatedState(initialState) {
  var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__read)((0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(initialState), 2),
      animationState = _a[0],
      setAnimationState = _a[1];

  var visualState = useVisualState({}, false);
  var element = (0,_utils_use_constant_mjs__WEBPACK_IMPORTED_MODULE_6__.useConstant)(function () {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    element.setProps({
      onUpdate: function onUpdate(v) {
        setAnimationState((0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({}, v));
      }
    });
  }, [setAnimationState, element]);
  var startAnimation = (0,_utils_use_constant_mjs__WEBPACK_IMPORTED_MODULE_6__.useConstant)(function () {
    return function (animationDefinition) {
      return (0,_render_utils_animation_mjs__WEBPACK_IMPORTED_MODULE_7__.animateVisualElement)(element, animationDefinition);
    };
  });
...
var easingDefinitionToFunction = function easingDefinitionToFunction(definition) {
  if (Array.isArray(definition)) {
    ...
    var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__read)(definition, 4),
        x1 = _a[0],
        y1 = _a[1],
        x2 = _a[2],
        y2 = _a[3];
...
function isTransitionDefined(_a) {
  ...
  var transition = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(_a, ["when", "delay", "delayChildren", "staggerChildren", "staggerDirection", "repeat", "repeatType", "repeatDelay", "from"]);
...
function convertTransitionToAnimationOptions(_a) {
  var ease = _a.ease,
      ...
      flip = _a.flip,
      loop = _a.loop,
      transition = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(_a, ["ease", "times", "yoyo", "flip", "loop"]);
...
var PresenceChild = function PresenceChild(_a) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0__.createElement(_context_PresenceContext_mjs__WEBPACK_IMPORTED_MODULE_4__.PresenceContext.Provider, {
    value: context
  }, children);
};
...
function onlyElements(children) {
  ...
  react__WEBPACK_IMPORTED_MODULE_0__.Children.forEach(children, function (child) {
    if ((0,react__WEBPACK_IMPORTED_MODULE_0__.isValidElement)(child)) filtered.push(child);
  });
  return filtered;
}
/**
...
var AnimatePresence = function AnimatePresence(_a) {
  ...
  var _d = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__read)((0,_utils_use_force_update_mjs__WEBPACK_IMPORTED_MODULE_2__.useForceUpdate)(), 1),
      forceRender = _d[0];
  ...
  var isMounted = (0,_utils_use_is_mounted_mjs__WEBPACK_IMPORTED_MODULE_4__.useIsMounted)(); // Filter out any children that aren't ReactElements. We can only track ReactElements with a props.key
  ...
  var presentChildren = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(childrenToRender); // A lookup table to quickly reference components by key

  var allChildren = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(new Map()).current; // If this is the initial component render, just deal with logic surrounding whether
  ...
  if (isInitialRender.current) {
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, childrenToRender.map(function (child) {
      return react__WEBPACK_IMPORTED_MODULE_0__.createElement(_PresenceChild_mjs__WEBPACK_IMPORTED_MODULE_7__.PresenceChild, {
  ...
  childrenToRender = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__spreadArray)([], (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__read)(childrenToRender), false); // Diff the keys of the currently-present and target children to update our
  // exiting list.
  ...
  exiting.forEach(function (key) {
    ...
    childrenToRender.splice(insertionIndex, 0, react__WEBPACK_IMPORTED_MODULE_0__.createElement(_PresenceChild_mjs__WEBPACK_IMPORTED_MODULE_7__.PresenceChild, {
      key: getChildKey(child),
      isPresent: false,
  ...
  childrenToRender = childrenToRender.map(function (child) {
    var key = child.key;
    return exiting.has(key) ? child : react__WEBPACK_IMPORTED_MODULE_0__.createElement(_PresenceChild_mjs__WEBPACK_IMPORTED_MODULE_7__.PresenceChild, {
      key: getChildKey(child),
      isPresent: true,
      presenceAffectsLayout: presenceAffectsLayout
    }, child);
  ...
  if ( true && exitBeforeEnter && childrenToRender.length > 1) {
    console.warn("You're attempting to animate multiple children within AnimatePresence, but its exitBeforeEnter prop is set to true. This will lead to odd visual behaviour.");
  }

  return react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, exiting.size ? childrenToRender : childrenToRender.map(function (child) {
...
/* harmony import */ var _LayoutGroup_index_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./LayoutGroup/index.mjs */ "./node_modules/framer-motion/dist/es/components/LayoutGroup/index.mjs");
...
var AnimateSharedLayout = function AnimateSharedLayout(_a) {
  var children = _a.children;
  return react__WEBPACK_IMPORTED_MODULE_0__.createElement(_LayoutGroup_index_mjs__WEBPACK_IMPORTED_MODULE_1__.LayoutGroup, {
    id: (0,_utils_use_constant_mjs__WEBPACK_IMPORTED_MODULE_2__.useConstant)(function () {
...
/* harmony import */ var _utils_use_force_update_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/use-force-update.mjs */ "./node_modules/framer-motion/dist/es/utils/use-force-update.mjs");
/* harmony import */ var _projection_node_group_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../projection/node/group.mjs */ "./node_modules/framer-motion/dist/es/projection/node/group.mjs");
...
var LayoutGroup = function LayoutGroup(_a) {
  ...
  var layoutGroupContext = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_context_LayoutGroupContext_mjs__WEBPACK_IMPORTED_MODULE_1__.LayoutGroupContext);
  var deprecatedLayoutGroupContext = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_context_DeprecatedLayoutGroupContext_mjs__WEBPACK_IMPORTED_MODULE_2__.DeprecatedLayoutGroupContext);

  var _e = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__read)((0,_utils_use_force_update_mjs__WEBPACK_IMPORTED_MODULE_4__.useForceUpdate)(), 2),
      forceRender = _e[0],
      key = _e[1];

  var context = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  ...
  if (context.current === null) {
    ...
    context.current = {
      id: id,
      group: shouldInheritGroup(inherit) ? (_c = layoutGroupContext === null || layoutGroupContext === void 0 ? void 0 : layoutGroupContext.group) !== null && _c !== void 0 ? _c : (0,_projection_node_group_mjs__WEBPACK_IMPORTED_MODULE_5__.nodeGroup)() : (0,_projection_node_group_mjs__WEBPACK_IMPORTED_MODULE_5__.nodeGroup)()
    };
  }

  var memoizedContext = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(function () {
    return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_3__.__assign)({}, context.current), {
      forceRender: forceRender
    });
  }, [key]);
  return react__WEBPACK_IMPORTED_MODULE_0__.createElement(_context_LayoutGroupContext_mjs__WEBPACK_IMPORTED_MODULE_1__.LayoutGroupContext.Provider, {
...
function LazyMotion(_a) {
  ...
  var _c = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__read)((0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(!isLazyBundle(features)), 2),
      setIsLoaded = _c[1];
  ...
  if (!isLazyBundle(features)) {
    var renderer = features.renderer,
        loadedFeatures = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(features, ["renderer"]);

    loadedRenderer.current = renderer;
    (0,_motion_features_definitions_mjs__WEBPACK_IMPORTED_MODULE_2__.loadFeatures)(loadedFeatures);
  }
    ...
    if (isLazyBundle(features)) {
      features().then(function (_a) {
        var renderer = _a.renderer,
            loadedFeatures = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(_a, ["renderer"]);
  ...
  return react__WEBPACK_IMPORTED_MODULE_0__.createElement(_context_LazyContext_mjs__WEBPACK_IMPORTED_MODULE_3__.LazyContext.Provider, {
    value: {
...
/* harmony import */ var _render_dom_utils_filter_props_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../render/dom/utils/filter-props.mjs */ "./node_modules/framer-motion/dist/es/render/dom/utils/filter-props.mjs");
...
function MotionConfig(_a) {
  var children = _a.children,
      ...
      config = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(_a, ["children", "isValidProp"]);
  ...
  config = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_1__.__assign)({}, (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_context_MotionConfigContext_mjs__WEBPACK_IMPORTED_MODULE_3__.MotionConfigContext)), config);
  /**
   * Don't allow isStatic to change between renders as it affects how many hooks
   * motion components fire.
   */

  config.isStatic = (0,_utils_use_constant_mjs__WEBPACK_IMPORTED_MODULE_4__.useConstant)(function () {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0__.createElement(_context_MotionConfigContext_mjs__WEBPACK_IMPORTED_MODULE_3__.MotionConfigContext.Provider, {
    value: context
  }, children);
}
...
/* harmony import */ var _render_dom_motion_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../render/dom/motion.mjs */ "./node_modules/framer-motion/dist/es/render/dom/motion.mjs");
...
/* harmony import */ var _utils_check_reorder_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/check-reorder.mjs */ "./node_modules/framer-motion/dist/es/components/Reorder/utils/check-reorder.mjs");
...
function ReorderGroup(_a, externalRef) {
  var children = _a.children,
      ...
      values = _a.values,
      props = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__rest)(_a, ["children", "as", "axis", "onReorder", "values"]);

  var Component = (0,_utils_use_constant_mjs__WEBPACK_IMPORTED_MODULE_3__.useConstant)(function () {
    return (0,_render_dom_motion_mjs__WEBPACK_IMPORTED_MODULE_4__.motion)(as);
  });
  var order = [];
  var isReordering = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(false);
  ...
  var context = {
    ...
    updateOrder: function updateOrder(id, offset, velocity) {
      ...
      var newOrder = (0,_utils_check_reorder_mjs__WEBPACK_IMPORTED_MODULE_5__.checkReorder)(order, id, offset, velocity);
  ...
  return react__WEBPACK_IMPORTED_MODULE_1__.createElement(Component, (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__assign)({}, props, {
    ref: externalRef
  }), react__WEBPACK_IMPORTED_MODULE_1__.createElement(_context_ReorderContext_mjs__WEBPACK_IMPORTED_MODULE_6__.ReorderContext.Provider, {
    value: context
  }, children));
}

var Group = (0,react__WEBPACK_IMPORTED_MODULE_1__.forwardRef)(ReorderGroup);
...
/* harmony import */ var hey_listen__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! hey-listen */ "./node_modules/hey-listen/dist/hey-listen.es.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _context_ReorderContext_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../context/ReorderContext.mjs */ "./node_modules/framer-motion/dist/es/context/ReorderContext.mjs");
/* harmony import */ var _render_dom_motion_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../render/dom/motion.mjs */ "./node_modules/framer-motion/dist/es/render/dom/motion.mjs");
...
function ReorderItem(_a, externalRef) {
  var children = _a.children,
      ...
      as = _b === void 0 ? "li" : _b,
      _onDrag = _a.onDrag,
      props = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__rest)(_a, ["children", "style", "value", "as", "onDrag"]);

  var Component = (0,_utils_use_constant_mjs__WEBPACK_IMPORTED_MODULE_5__.useConstant)(function () {
    return (0,_render_dom_motion_mjs__WEBPACK_IMPORTED_MODULE_6__.motion)(as);
  });
  var context = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(_context_ReorderContext_mjs__WEBPACK_IMPORTED_MODULE_7__.ReorderContext);
  var point = {
  ...
  var zIndex = (0,_value_use_transform_mjs__WEBPACK_IMPORTED_MODULE_8__.useTransform)([point.x, point.y], function (_a) {
  ...
  var layout = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  ...
  return react__WEBPACK_IMPORTED_MODULE_1__.createElement(Component, (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__assign)({
    drag: axis
  }, props, {
    dragSnapToOrigin: true,
    style: (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_4__.__assign)({}, style), {
      x: point.x,
      y: point.y,
      zIndex: zIndex
    }),
...
var Item = (0,react__WEBPACK_IMPORTED_MODULE_1__.forwardRef)(ReorderItem);
...
function checkReorder(order, value, offset, velocity) {
  ...
  var nextItemCenter = (0,popmotion__WEBPACK_IMPORTED_MODULE_0__.mix)(nextLayout.min, nextLayout.max, 0.5);
...
var DeprecatedLayoutGroupContext = (0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)(null);
...
var LazyContext = (0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)({
  strict: false
});
...
function useCreateMotionContext(props) {
  var _a = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.getCurrentTreeVariants)(props, (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_index_mjs__WEBPACK_IMPORTED_MODULE_2__.MotionContext)),
      initial = _a.initial,
      animate = _a.animate;
...
var ReorderContext = (0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)(null);
...
function () {
  function PanSession(event, handlers, _a) {
    ...
    var timestamp = (0,framesync__WEBPACK_IMPORTED_MODULE_0__.getFrameData)().timestamp;
    this.history = [(0,tslib__WEBPACK_IMPORTED_MODULE_2__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_2__.__assign)({}, point), {
      timestamp: timestamp
    })];
...
function () {
  ...
  VisualElementDragControls.prototype.start = function (originEvent, _a) {
    ...
    var onStart = function onStart(event, info) {
      ...
      if (drag && !dragPropagation) {
        ...
        _this.openGlobalLock = (0,_utils_lock_mjs__WEBPACK_IMPORTED_MODULE_3__.getGlobalLock)(drag); // If we don 't have the lock, don't start dragging
  ...
  VisualElementDragControls.prototype.getProps = function () {
    ...
    var _a = props.drag,
        ...
        dragElastic = _e === void 0 ? _utils_constraints_mjs__WEBPACK_IMPORTED_MODULE_9__.defaultElastic : _e,
...
/* harmony export */   "AnimateSharedLayout": function() { return /* reexport safe */ _components_AnimateSharedLayout_mjs__WEBPACK_IMPORTED_MODULE_3__.AnimateSharedLayout; },
/* harmony export */   "MotionConfig": function() { return /* reexport safe */ _components_MotionConfig_index_mjs__WEBPACK_IMPORTED_MODULE_4__.MotionConfig; },
/* harmony export */   "LazyMotion": function() { return /* reexport safe */ _components_LazyMotion_index_mjs__WEBPACK_IMPORTED_MODULE_5__.LazyMotion; },
/* harmony export */   "LayoutGroup": function() { return /* reexport safe */ _components_LayoutGroup_index_mjs__WEBPACK_IMPORTED_MODULE_6__.LayoutGroup; },
/* harmony export */   "Reorder": function() { return /* reexport safe */ _components_Reorder_index_mjs__WEBPACK_IMPORTED_MODULE_7__.Reorder; },
/* harmony export */   "domAnimation": function() { return /* reexport safe */ _render_dom_features_animation_mjs__WEBPACK_IMPORTED_MODULE_8__.domAnimation; },
/* harmony export */   "domMax": function() { return /* reexport safe */ _render_dom_features_max_mjs__WEBPACK_IMPORTED_MODULE_9__.domMax; },
/* harmony export */   "useMotionValue": function() { return /* reexport safe */ _value_use_motion_value_mjs__WEBPACK_IMPORTED_MODULE_10__.useMotionValue; },
/* harmony export */   "useMotionTemplate": function() { return /* reexport safe */ _value_use_motion_template_mjs__WEBPACK_IMPORTED_MODULE_11__.useMotionTemplate; },
/* harmony export */   "MotionValue": function() { return /* reexport safe */ _value_index_mjs__WEBPACK_IMPORTED_MODULE_12__.MotionValue; },
/* harmony export */   "motionValue": function() { return /* reexport safe */ _value_index_mjs__WEBPACK_IMPORTED_MODULE_12__.motionValue; },
/* harmony export */   "resolveMotionValue": function() { return /* reexport safe */ _value_utils_resolve_motion_value_mjs__WEBPACK_IMPORTED_MODULE_13__.resolveMotionValue; },
/* harmony export */   "useTransform": function() { return /* reexport safe */ _value_use_transform_mjs__WEBPACK_IMPORTED_MODULE_14__.useTransform; },
/* harmony export */   "useSpring": function() { return /* reexport safe */ _value_use_spring_mjs__WEBPACK_IMPORTED_MODULE_15__.useSpring; },
/* harmony export */   "useVelocity": function() { return /* reexport safe */ _value_use_velocity_mjs__WEBPACK_IMPORTED_MODULE_16__.useVelocity; },
/* harmony export */   "useElementScroll": function() { return /* reexport safe */ _value_scroll_use_element_scroll_mjs__WEBPACK_IMPORTED_MODULE_17__.useElementScroll; },
/* harmony export */   "useViewportScroll": function() { return /* reexport safe */ _value_scroll_use_viewport_scroll_mjs__WEBPACK_IMPORTED_MODULE_18__.useViewportScroll; },
/* harmony export */   "useTime": function() { return /* reexport safe */ _value_use_time_mjs__WEBPACK_IMPORTED_MODULE_19__.useTime; },
/* harmony export */   "useReducedMotion": function() { return /* reexport safe */ _utils_use_reduced_motion_mjs__WEBPACK_IMPORTED_MODULE_20__.useReducedMotion; },
/* harmony export */   "useReducedMotionConfig": function() { return /* reexport safe */ _utils_use_reduced_motion_mjs__WEBPACK_IMPORTED_MODULE_20__.useReducedMotionConfig; },
/* harmony export */   "animationControls": function() { return /* reexport safe */ _animation_animation_controls_mjs__WEBPACK_IMPORTED_MODULE_21__.animationControls; },
/* harmony export */   "useAnimation": function() { return /* reexport safe */ _animation_use_animation_mjs__WEBPACK_IMPORTED_MODULE_22__.useAnimation; },
/* harmony export */   "useAnimationFrame": function() { return /* reexport safe */ _utils_use_animation_frame_mjs__WEBPACK_IMPORTED_MODULE_23__.useAnimationFrame; },
/* harmony export */   "animate": function() { return /* reexport safe */ _animation_animate_mjs__WEBPACK_IMPORTED_MODULE_24__.animate; },
/* harmony export */   "animateVisualElement": function() { return /* reexport safe */ _render_utils_animation_mjs__WEBPACK_IMPORTED_MODULE_25__.animateVisualElement; },
/* harmony export */   "useCycle": function() { return /* reexport safe */ _utils_use_cycle_mjs__WEBPACK_IMPORTED_MODULE_26__.useCycle; },
/* harmony export */   "transform": function() { return /* reexport safe */ _utils_transform_mjs__WEBPACK_IMPORTED_MODULE_27__.transform; },
/* harmony export */   "isValidMotionProp": function() { return /* reexport safe */ _motion_utils_valid_prop_mjs__WEBPACK_IMPORTED_MODULE_28__.isValidMotionProp; },
/* harmony export */   "useIsPresent": function() { return /* reexport safe */ _components_AnimatePresence_use_presence_mjs__WEBPACK_IMPORTED_MODULE_29__.useIsPresent; },
/* harmony export */   "usePresence": function() { return /* reexport safe */ _components_AnimatePresence_use_presence_mjs__WEBPACK_IMPORTED_MODULE_29__.usePresence; },
/* harmony export */   "DragControls": function() { return /* reexport safe */ _gestures_drag_use_drag_controls_mjs__WEBPACK_IMPORTED_MODULE_30__.DragControls; },
/* harmony export */   "useDragControls": function() { return /* reexport safe */ _gestures_drag_use_drag_controls_mjs__WEBPACK_IMPORTED_MODULE_30__.useDragControls; },
...
/* harmony export */   "createMotionComponent": function() { return /* reexport safe */ _motion_index_mjs__WEBPACK_IMPORTED_MODULE_32__.createMotionComponent; },
/* harmony export */   "visualElement": function() { return /* reexport safe */ _render_index_mjs__WEBPACK_IMPORTED_MODULE_33__.visualElement; },
/* harmony export */   "addScaleCorrector": function() { return /* reexport safe */ _projection_styles_scale_correction_mjs__WEBPACK_IMPORTED_MODULE_34__.addScaleCorrector; },
/* harmony export */   "useInstantTransition": function() { return /* reexport safe */ _utils_use_instant_transition_mjs__WEBPACK_IMPORTED_MODULE_35__.useInstantTransition; },
/* harmony export */   "useInstantLayoutTransition": function() { return /* reexport safe */ _projection_use_instant_layout_transition_mjs__WEBPACK_IMPORTED_MODULE_36__.useInstantLayoutTransition; },
/* harmony export */   "useResetProjection": function() { return /* reexport safe */ _projection_use_reset_projection_mjs__WEBPACK_IMPORTED_MODULE_37__.useResetProjection; },
/* harmony export */   "MotionContext": function() { return /* reexport safe */ _context_MotionContext_index_mjs__WEBPACK_IMPORTED_MODULE_38__.MotionContext; },
/* harmony export */   "useVisualElementContext": function() { return /* reexport safe */ _context_MotionContext_index_mjs__WEBPACK_IMPORTED_MODULE_38__.useVisualElementContext; },
/* harmony export */   "MotionConfigContext": function() { return /* reexport safe */ _context_MotionConfigContext_mjs__WEBPACK_IMPORTED_MODULE_39__.MotionConfigContext; },
/* harmony export */   "PresenceContext": function() { return /* reexport safe */ _context_PresenceContext_mjs__WEBPACK_IMPORTED_MODULE_40__.PresenceContext; },
/* harmony export */   "LayoutGroupContext": function() { return /* reexport safe */ _context_LayoutGroupContext_mjs__WEBPACK_IMPORTED_MODULE_41__.LayoutGroupContext; },
/* harmony export */   "DeprecatedLayoutGroupContext": function() { return /* reexport safe */ _context_DeprecatedLayoutGroupContext_mjs__WEBPACK_IMPORTED_MODULE_42__.DeprecatedLayoutGroupContext; },
/* harmony export */   "SwitchLayoutGroupContext": function() { return /* reexport safe */ _context_SwitchLayoutGroupContext_mjs__WEBPACK_IMPORTED_MODULE_43__.SwitchLayoutGroupContext; },
/* harmony export */   "FlatTree": function() { return /* reexport safe */ _render_utils_flat_tree_mjs__WEBPACK_IMPORTED_MODULE_44__.FlatTree; },
/* harmony export */   "useDeprecatedAnimatedState": function() { return /* reexport safe */ _animation_use_animated_state_mjs__WEBPACK_IMPORTED_MODULE_45__.useAnimatedState; },
/* harmony export */   "useDeprecatedInvertedScale": function() { return /* reexport safe */ _value_use_inverted_scale_mjs__WEBPACK_IMPORTED_MODULE_46__.useInvertedScale; },
/* harmony export */   "AnimationType": function() { return /* reexport safe */ _render_utils_types_mjs__WEBPACK_IMPORTED_MODULE_47__.AnimationType; },
/* harmony export */   "animations": function() { return /* reexport safe */ _motion_features_animations_mjs__WEBPACK_IMPORTED_MODULE_48__.animations; },
/* harmony export */   "checkTargetForNewValues": function() { return /* reexport safe */ _render_utils_setters_mjs__WEBPACK_IMPORTED_MODULE_49__.checkTargetForNewValues; },
/* harmony export */   "createBox": function() { return /* reexport safe */ _projection_geometry_models_mjs__WEBPACK_IMPORTED_MODULE_50__.createBox; },
/* harmony export */   "calcLength": function() { return /* reexport safe */ _projection_geometry_delta_calc_mjs__WEBPACK_IMPORTED_MODULE_51__.calcLength; },
/* harmony export */   "filterProps": function() { return /* reexport safe */ _render_dom_utils_filter_props_mjs__WEBPACK_IMPORTED_MODULE_52__.filterProps; },
/* harmony export */   "makeUseVisualState": function() { return /* reexport safe */ _motion_utils_use_visual_state_mjs__WEBPACK_IMPORTED_MODULE_53__.makeUseVisualState; },
/* harmony export */   "isDragActive": function() { return /* reexport safe */ _gestures_drag_utils_lock_mjs__WEBPACK_IMPORTED_MODULE_54__.isDragActive; },
/* harmony export */   "addPointerEvent": function() { return /* reexport safe */ _events_use_pointer_event_mjs__WEBPACK_IMPORTED_MODULE_55__.addPointerEvent; },
/* harmony export */   "wrapHandler": function() { return /* reexport safe */ _events_event_info_mjs__WEBPACK_IMPORTED_MODULE_56__.wrapHandler; },
/* harmony export */   "isMotionValue": function() { return /* reexport safe */ _value_utils_is_motion_value_mjs__WEBPACK_IMPORTED_MODULE_57__.isMotionValue; },
/* harmony export */   "isBrowser": function() { return /* reexport safe */ _utils_is_browser_mjs__WEBPACK_IMPORTED_MODULE_58__.isBrowser; },
/* harmony export */   "useUnmountEffect": function() { return /* reexport safe */ _utils_use_unmount_effect_mjs__WEBPACK_IMPORTED_MODULE_59__.useUnmountEffect; },
/* harmony export */   "useIsomorphicLayoutEffect": function() { return /* reexport safe */ _utils_use_isomorphic_effect_mjs__WEBPACK_IMPORTED_MODULE_60__.useIsomorphicLayoutEffect; },
/* harmony export */   "useForceUpdate": function() { return /* reexport safe */ _utils_use_force_update_mjs__WEBPACK_IMPORTED_MODULE_61__.useForceUpdate; }
/* harmony export */ });
...
/* harmony import */ var _render_dom_motion_minimal_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./render/dom/motion-minimal.mjs */ "./node_modules/framer-motion/dist/es/render/dom/motion-minimal.mjs");
/* harmony import */ var _components_AnimatePresence_index_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/AnimatePresence/index.mjs */ "./node_modules/framer-motion/dist/es/components/AnimatePresence/index.mjs");
/* harmony import */ var _components_AnimateSharedLayout_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/AnimateSharedLayout.mjs */ "./node_modules/framer-motion/dist/es/components/AnimateSharedLayout.mjs");
/* harmony import */ var _components_MotionConfig_index_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/MotionConfig/index.mjs */ "./node_modules/framer-motion/dist/es/components/MotionConfig/index.mjs");
/* harmony import */ var _components_LazyMotion_index_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/LazyMotion/index.mjs */ "./node_modules/framer-motion/dist/es/components/LazyMotion/index.mjs");
/* harmony import */ var _components_LayoutGroup_index_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/LayoutGroup/index.mjs */ "./node_modules/framer-motion/dist/es/components/LayoutGroup/index.mjs");
/* harmony import */ var _components_Reorder_index_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/Reorder/index.mjs */ "./node_modules/framer-motion/dist/es/components/Reorder/index.mjs");
/* harmony import */ var _render_dom_features_animation_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./render/dom/features-animation.mjs */ "./node_modules/framer-motion/dist/es/render/dom/features-animation.mjs");
/* harmony import */ var _render_dom_features_max_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./render/dom/features-max.mjs */ "./node_modules/framer-motion/dist/es/render/dom/features-max.mjs");
/* harmony import */ var _value_use_motion_value_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./value/use-motion-value.mjs */ "./node_modules/framer-motion/dist/es/value/use-motion-value.mjs");
/* harmony import */ var _value_use_motion_template_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./value/use-motion-template.mjs */ "./node_modules/framer-motion/dist/es/value/use-motion-template.mjs");
...
/* harmony import */ var _value_utils_resolve_motion_value_mjs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./value/utils/resolve-motion-value.mjs */ "./node_modules/framer-motion/dist/es/value/utils/resolve-motion-value.mjs");
/* harmony import */ var _value_use_transform_mjs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./value/use-transform.mjs */ "./node_modules/framer-motion/dist/es/value/use-transform.mjs");
/* harmony import */ var _value_use_spring_mjs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./value/use-spring.mjs */ "./node_modules/framer-motion/dist/es/value/use-spring.mjs");
/* harmony import */ var _value_use_velocity_mjs__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./value/use-velocity.mjs */ "./node_modules/framer-motion/dist/es/value/use-velocity.mjs");
/* harmony import */ var _value_scroll_use_element_scroll_mjs__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./value/scroll/use-element-scroll.mjs */ "./node_modules/framer-motion/dist/es/value/scroll/use-element-scroll.mjs");
/* harmony import */ var _value_scroll_use_viewport_scroll_mjs__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./value/scroll/use-viewport-scroll.mjs */ "./node_modules/framer-motion/dist/es/value/scroll/use-viewport-scroll.mjs");
/* harmony import */ var _value_use_time_mjs__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./value/use-time.mjs */ "./node_modules/framer-motion/dist/es/value/use-time.mjs");
/* harmony import */ var _utils_use_reduced_motion_mjs__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./utils/use-reduced-motion.mjs */ "./node_modules/framer-motion/dist/es/utils/use-reduced-motion.mjs");
/* harmony import */ var _animation_animation_controls_mjs__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./animation/animation-controls.mjs */ "./node_modules/framer-motion/dist/es/animation/animation-controls.mjs");
/* harmony import */ var _animation_use_animation_mjs__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./animation/use-animation.mjs */ "./node_modules/framer-motion/dist/es/animation/use-animation.mjs");
/* harmony import */ var _utils_use_animation_frame_mjs__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./utils/use-animation-frame.mjs */ "./node_modules/framer-motion/dist/es/utils/use-animation-frame.mjs");
/* harmony import */ var _animation_animate_mjs__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./animation/animate.mjs */ "./node_modules/framer-motion/dist/es/animation/animate.mjs");
/* harmony import */ var _render_utils_animation_mjs__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./render/utils/animation.mjs */ "./node_modules/framer-motion/dist/es/render/utils/animation.mjs");
/* harmony import */ var _utils_use_cycle_mjs__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./utils/use-cycle.mjs */ "./node_modules/framer-motion/dist/es/utils/use-cycle.mjs");
/* harmony import */ var _utils_transform_mjs__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./utils/transform.mjs */ "./node_modules/framer-motion/dist/es/utils/transform.mjs");
/* harmony import */ var _motion_utils_valid_prop_mjs__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./motion/utils/valid-prop.mjs */ "./node_modules/framer-motion/dist/es/motion/utils/valid-prop.mjs");
/* harmony import */ var _components_AnimatePresence_use_presence_mjs__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./components/AnimatePresence/use-presence.mjs */ "./node_modules/framer-motion/dist/es/components/AnimatePresence/use-presence.mjs");
/* harmony import */ var _gestures_drag_use_drag_controls_mjs__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./gestures/drag/use-drag-controls.mjs */ "./node_modules/framer-motion/dist/es/gestures/drag/use-drag-controls.mjs");
/* harmony import */ var _events_use_dom_event_mjs__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./events/use-dom-event.mjs */ "./node_modules/framer-motion/dist/es/events/use-dom-event.mjs");
/* harmony import */ var _motion_index_mjs__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./motion/index.mjs */ "./node_modules/framer-motion/dist/es/motion/index.mjs");
/* harmony import */ var _render_index_mjs__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./render/index.mjs */ "./node_modules/framer-motion/dist/es/render/index.mjs");
/* harmony import */ var _projection_styles_scale_correction_mjs__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./projection/styles/scale-correction.mjs */ "./node_modules/framer-motion/dist/es/projection/styles/scale-correction.mjs");
/* harmony import */ var _utils_use_instant_transition_mjs__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./utils/use-instant-transition.mjs */ "./node_modules/framer-motion/dist/es/utils/use-instant-transition.mjs");
/* harmony import */ var _projection_use_instant_layout_transition_mjs__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./projection/use-instant-layout-transition.mjs */ "./node_modules/framer-motion/dist/es/projection/use-instant-layout-transition.mjs");
/* harmony import */ var _projection_use_reset_projection_mjs__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./projection/use-reset-projection.mjs */ "./node_modules/framer-motion/dist/es/projection/use-reset-projection.mjs");
/* harmony import */ var _context_MotionContext_index_mjs__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./context/MotionContext/index.mjs */ "./node_modules/framer-motion/dist/es/context/MotionContext/index.mjs");
/* harmony import */ var _context_MotionConfigContext_mjs__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./context/MotionConfigContext.mjs */ "./node_modules/framer-motion/dist/es/context/MotionConfigContext.mjs");
/* harmony import */ var _context_PresenceContext_mjs__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./context/PresenceContext.mjs */ "./node_modules/framer-motion/dist/es/context/PresenceContext.mjs");
/* harmony import */ var _context_LayoutGroupContext_mjs__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./context/LayoutGroupContext.mjs */ "./node_modules/framer-motion/dist/es/context/LayoutGroupContext.mjs");
/* harmony import */ var _context_DeprecatedLayoutGroupContext_mjs__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ./context/DeprecatedLayoutGroupContext.mjs */ "./node_modules/framer-motion/dist/es/context/DeprecatedLayoutGroupContext.mjs");
/* harmony import */ var _context_SwitchLayoutGroupContext_mjs__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./context/SwitchLayoutGroupContext.mjs */ "./node_modules/framer-motion/dist/es/context/SwitchLayoutGroupContext.mjs");
/* harmony import */ var _render_utils_flat_tree_mjs__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! ./render/utils/flat-tree.mjs */ "./node_modules/framer-motion/dist/es/render/utils/flat-tree.mjs");
/* harmony import */ var _animation_use_animated_state_mjs__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! ./animation/use-animated-state.mjs */ "./node_modules/framer-motion/dist/es/animation/use-animated-state.mjs");
/* harmony import */ var _value_use_inverted_scale_mjs__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! ./value/use-inverted-scale.mjs */ "./node_modules/framer-motion/dist/es/value/use-inverted-scale.mjs");
/* harmony import */ var _render_utils_types_mjs__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ./render/utils/types.mjs */ "./node_modules/framer-motion/dist/es/render/utils/types.mjs");
/* harmony import */ var _motion_features_animations_mjs__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./motion/features/animations.mjs */ "./node_modules/framer-motion/dist/es/motion/features/animations.mjs");
/* harmony import */ var _render_utils_setters_mjs__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! ./render/utils/setters.mjs */ "./node_modules/framer-motion/dist/es/render/utils/setters.mjs");
/* harmony import */ var _projection_geometry_models_mjs__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! ./projection/geometry/models.mjs */ "./node_modules/framer-motion/dist/es/projection/geometry/models.mjs");
/* harmony import */ var _projection_geometry_delta_calc_mjs__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! ./projection/geometry/delta-calc.mjs */ "./node_modules/framer-motion/dist/es/projection/geometry/delta-calc.mjs");
/* harmony import */ var _render_dom_utils_filter_props_mjs__WEBPACK_IMPORTED_MODULE_52__ = __webpack_require__(/*! ./render/dom/utils/filter-props.mjs */ "./node_modules/framer-motion/dist/es/render/dom/utils/filter-props.mjs");
/* harmony import */ var _motion_utils_use_visual_state_mjs__WEBPACK_IMPORTED_MODULE_53__ = __webpack_require__(/*! ./motion/utils/use-visual-state.mjs */ "./node_modules/framer-motion/dist/es/motion/utils/use-visual-state.mjs");
/* harmony import */ var _gestures_drag_utils_lock_mjs__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(/*! ./gestures/drag/utils/lock.mjs */ "./node_modules/framer-motion/dist/es/gestures/drag/utils/lock.mjs");
/* harmony import */ var _events_use_pointer_event_mjs__WEBPACK_IMPORTED_MODULE_55__ = __webpack_require__(/*! ./events/use-pointer-event.mjs */ "./node_modules/framer-motion/dist/es/events/use-pointer-event.mjs");
/* harmony import */ var _events_event_info_mjs__WEBPACK_IMPORTED_MODULE_56__ = __webpack_require__(/*! ./events/event-info.mjs */ "./node_modules/framer-motion/dist/es/events/event-info.mjs");
/* harmony import */ var _value_utils_is_motion_value_mjs__WEBPACK_IMPORTED_MODULE_57__ = __webpack_require__(/*! ./value/utils/is-motion-value.mjs */ "./node_modules/framer-motion/dist/es/value/utils/is-motion-value.mjs");
/* harmony import */ var _utils_is_browser_mjs__WEBPACK_IMPORTED_MODULE_58__ = __webpack_require__(/*! ./utils/is-browser.mjs */ "./node_modules/framer-motion/dist/es/utils/is-browser.mjs");
/* harmony import */ var _utils_use_unmount_effect_mjs__WEBPACK_IMPORTED_MODULE_59__ = __webpack_require__(/*! ./utils/use-unmount-effect.mjs */ "./node_modules/framer-motion/dist/es/utils/use-unmount-effect.mjs");
/* harmony import */ var _utils_use_isomorphic_effect_mjs__WEBPACK_IMPORTED_MODULE_60__ = __webpack_require__(/*! ./utils/use-isomorphic-effect.mjs */ "./node_modules/framer-motion/dist/es/utils/use-isomorphic-effect.mjs");
/* harmony import */ var _utils_use_force_update_mjs__WEBPACK_IMPORTED_MODULE_61__ = __webpack_require__(/*! ./utils/use-force-update.mjs */ "./node_modules/framer-motion/dist/es/utils/use-force-update.mjs");
...
var animations = {
  ...
  exit: (0,_utils_make_renderless_component_mjs__WEBPACK_IMPORTED_MODULE_1__.makeRenderlessComponent)(function (props) {
    ...
    var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__read)((0,_components_AnimatePresence_use_presence_mjs__WEBPACK_IMPORTED_MODULE_5__.usePresence)(), 2),
        isPresent = _a[0],
        safeToRemove = _a[1];
...
function MeasureLayout(props) {
  var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__read)((0,_components_AnimatePresence_use_presence_mjs__WEBPACK_IMPORTED_MODULE_5__.usePresence)(), 2),
      isPresent = _a[0],
      safeToRemove = _a[1];
  ...
  return react__WEBPACK_IMPORTED_MODULE_1__.createElement(MeasureLayoutWithContext, (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__assign)({}, props, {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "layoutFeatures": function() { return /* binding */ layoutFeatures; }
/* harmony export */ });
...
function useFeatures(props, visualElement, preloadedFeatures) {
  ...
  if ( true && preloadedFeatures && lazyContext.strict) {
  ...
  for (var i = 0; i < numFeatures; i++) {
    ...
    var _a = _definitions_mjs__WEBPACK_IMPORTED_MODULE_2__.featureDefinitions[name_1],
    ...
    if (isEnabled(props) && Component) {
      features.push(react__WEBPACK_IMPORTED_MODULE_0__.createElement(Component, (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__assign)({
        key: name_1
      }, props, {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "useProjection": function() { return /* binding */ useProjection; }
/* harmony export */ });
...
function initIntersectionObserver(_a) {
  var root = _a.root,
      options = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__rest)(_a, ["root"]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "useViewport": function() { return /* binding */ useViewport; }
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _render_utils_types_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../render/utils/types.mjs */ "./node_modules/framer-motion/dist/es/render/utils/types.mjs");
...
function createMotionComponent(_a) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement(_utils_VisualElementHandler_mjs__WEBPACK_IMPORTED_MODULE_10__.VisualElementHandler, {
      visualElement: context.visualElement,
      props: (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_2__.__assign)({}, config), props)
    }, features, react__WEBPACK_IMPORTED_MODULE_0__.createElement(_context_MotionContext_index_mjs__WEBPACK_IMPORTED_MODULE_11__.MotionContext.Provider, {
      value: context
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VisualElementHandler": function() { return /* binding */ VisualElementHandler; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.mjs");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
...
function makeLatestValues(props, context, presenceContext, scrapeMotionValues) {
  ...
  if (variantToSet && typeof variantToSet !== "boolean" && !(0,_animation_utils_is_animation_controls_mjs__WEBPACK_IMPORTED_MODULE_6__.isAnimationControls)(variantToSet)) {
    ...
    list.forEach(function (definition) {
      ...
      var target = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__rest)(resolved, ["transitionEnd", "transition"]);
...
function transformAxis(axis, transforms, _a) {
  var _b = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__read)(_a, 3),
      key = _b[0],
      scaleKey = _b[1],
      originKey = _b[2];

  var axisOrigin = transforms[originKey] !== undefined ? transforms[originKey] : 0.5;
  var originPoint = (0,popmotion__WEBPACK_IMPORTED_MODULE_2__.mix)(axis.min, axis.max, axisOrigin); // Apply the axis delta to the final axis
...
function removeAxisTransforms(axis, transforms, _a, origin, sourceAxis) {
  var _b = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__read)(_a, 3),
      key = _b[0],
      scaleKey = _b[1],
      originKey = _b[2];
  ...
  return (
    ...
    function () {
      ...
      ProjectionNode.prototype.mount = function (instance, isLayoutDirty) {
        ...
        if (this.options.animate !== false && visualElement && (layoutId || layout)) {
          this.addEventListener("didUpdate", function (_a) {
            ...
            var targetChanged = !_this.targetLayout || !(0,_geometry_utils_mjs__WEBPACK_IMPORTED_MODULE_4__.boxEquals)(_this.targetLayout, newLayout) || hasRelativeTargetChanged;
            /**
            ...
            if (((_d = _this.resumeFrom) === null || _d === void 0 ? void 0 : _d.instance) || hasOnlyRelativeTargetChanged || hasLayoutChanged && (targetChanged || !_this.currentAnimation)) {
              ...
              var animationOptions = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_1__.__assign)({}, (0,_animation_utils_transitions_mjs__WEBPACK_IMPORTED_MODULE_5__.getValueTransition)(layoutTransition, "layout")), {
      ...
      ProjectionNode.prototype.resetTransform = function () {
        ...
        if (isResetRequested && (hasProjection || (0,_utils_has_transform_mjs__WEBPACK_IMPORTED_MODULE_7__.hasTransform)(this.latestValues) || transformTemplateHasChanged)) {
      ...
      ProjectionNode.prototype.measure = function () {
        ...
        if (!visualElement) return (0,_geometry_models_mjs__WEBPACK_IMPORTED_MODULE_6__.createBox)();
      ...
      ProjectionNode.prototype.applyTransform = function (box, transformOnly) {
        ...
        for (var i = 0; i < this.path.length; i++) {
          ...
          if (!(0,_utils_has_transform_mjs__WEBPACK_IMPORTED_MODULE_7__.hasTransform)(node.latestValues)) continue;
      ...
      ProjectionNode.prototype.getClosestProjectingParent = function () {
        if (!this.parent || (0,_utils_has_transform_mjs__WEBPACK_IMPORTED_MODULE_7__.hasTransform)(this.parent.latestValues)) return undefined;
      ...
      ProjectionNode.prototype.startAnimation = function (options) {
        ...
        this.pendingAnimation = framesync__WEBPACK_IMPORTED_MODULE_0__.default.update(function () {
          ...
          _this.currentAnimation = (0,_animation_animate_mjs__WEBPACK_IMPORTED_MODULE_14__.animate)(0, animationTarget, (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_1__.__assign)({}, options), {
      ...
      ProjectionNode.prototype.getProjectionStyles = function (styleProp) {
        ...
        if (this.needsReset) {
          this.needsReset = false;
          styles.opacity = "";
          styles.pointerEvents = (0,_value_utils_resolve_motion_value_mjs__WEBPACK_IMPORTED_MODULE_17__.resolveMotionValue)(styleProp.pointerEvents) || "";
        ...
        if (!this.projectionDelta || !this.layout || !lead.target) {
          ...
          if (this.options.layoutId) {
            ...
            emptyStyles.pointerEvents = (0,_value_utils_resolve_motion_value_mjs__WEBPACK_IMPORTED_MODULE_17__.resolveMotionValue)(styleProp.pointerEvents) || "";
          }
        ...
        for (var key in _styles_scale_correction_mjs__WEBPACK_IMPORTED_MODULE_18__.scaleCorrectors) {
          ...
          var _h = _styles_scale_correction_mjs__WEBPACK_IMPORTED_MODULE_18__.scaleCorrectors[key],
              correct = _h.correct,
              applyTo = _h.applyTo;
        ...
        if (this.options.layoutId) {
          styles.pointerEvents = lead === this ? (0,_value_utils_resolve_motion_value_mjs__WEBPACK_IMPORTED_MODULE_17__.resolveMotionValue)(styleProp.pointerEvents) || "" : "none";
        }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "useProjectionId": function() { return /* binding */ useProjectionId; }
/* harmony export */ });
/* harmony import */ var _utils_use_constant_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/use-constant.mjs */ "./node_modules/framer-motion/dist/es/utils/use-constant.mjs");
...
var correctBoxShadow = {
  correct: function correct(latest, _a) {
    ...
    var shadow = style_value_types__WEBPACK_IMPORTED_MODULE_1__.complex.parse(latest); // TODO: Doesn't support multiple shadows
    ...
    var averageScale = (0,popmotion__WEBPACK_IMPORTED_MODULE_2__.mix)(xScale, yScale, 0.5); // Blur
...
/* harmony export */ });
/* harmony import */ var _node_HTMLProjectionNode_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node/HTMLProjectionNode.mjs */ "./node_modules/framer-motion/dist/es/projection/node/HTMLProjectionNode.mjs");
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _node_HTMLProjectionNode_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node/HTMLProjectionNode.mjs */ "./node_modules/framer-motion/dist/es/projection/node/HTMLProjectionNode.mjs");



function useResetProjection() {
  var reset = react__WEBPACK_IMPORTED_MODULE_0__.useCallback(function () {
    var root = _node_HTMLProjectionNode_mjs__WEBPACK_IMPORTED_MODULE_1__.rootProjectionNode.current;
    if (!root) return;
    root.resetTree();
  }, []);
  return reset;
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.mjs");
/* harmony import */ var _motion_features_animations_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../motion/features/animations.mjs */ "./node_modules/framer-motion/dist/es/motion/features/animations.mjs");
/* harmony import */ var _motion_features_gestures_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../motion/features/gestures.mjs */ "./node_modules/framer-motion/dist/es/motion/features/gestures.mjs");
/* harmony import */ var _create_visual_element_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./create-visual-element.mjs */ "./node_modules/framer-motion/dist/es/render/dom/create-visual-element.mjs");
...
var domAnimation = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_0__.__assign)({
  renderer: _create_visual_element_mjs__WEBPACK_IMPORTED_MODULE_1__.createDomVisualElement
}, _motion_features_animations_mjs__WEBPACK_IMPORTED_MODULE_2__.animations), _motion_features_gestures_mjs__WEBPACK_IMPORTED_MODULE_3__.gestureAnimations);
...
/* harmony import */ var _features_animation_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./features-animation.mjs */ "./node_modules/framer-motion/dist/es/render/dom/features-animation.mjs");
/* harmony import */ var _projection_node_HTMLProjectionNode_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../projection/node/HTMLProjectionNode.mjs */ "./node_modules/framer-motion/dist/es/projection/node/HTMLProjectionNode.mjs");
...
var domMax = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_0__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_0__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_0__.__assign)({}, _features_animation_mjs__WEBPACK_IMPORTED_MODULE_1__.domAnimation), _motion_features_drag_mjs__WEBPACK_IMPORTED_MODULE_2__.drag), _motion_features_layout_index_mjs__WEBPACK_IMPORTED_MODULE_3__.layoutFeatures), {
  projectionNodeConstructor: _projection_node_HTMLProjectionNode_mjs__WEBPACK_IMPORTED_MODULE_4__.HTMLProjectionNode
});
...
var m = (0,_motion_proxy_mjs__WEBPACK_IMPORTED_MODULE_0__.createMotionProxy)(_utils_create_config_mjs__WEBPACK_IMPORTED_MODULE_1__.createDomMotionConfig);
...
function parseCSSVariable(current) {
  ...
  var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__read)(match, 3),
      token = _a[1],
      fallback = _a[2];
...
function getVariableValue(current, element, depth) {
  ...
  var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__read)(parseCSSVariable(current), 2),
      token = _a[0],
...
function getAnimatableNone(key, value) {
  ...
  if (defaultValueType !== style_value_types__WEBPACK_IMPORTED_MODULE_1__.filter) defaultValueType = style_value_types__WEBPACK_IMPORTED_MODULE_2__.complex; // If value is not recognised as animatable, ie "none", create an animatable version origin based on the target
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "int": function() { return /* binding */ _int; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.mjs");
/* harmony import */ var style_value_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! style-value-types */ "./node_modules/style-value-types/dist/es/numbers/index.mjs");
...
var _int = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_0__.__assign)({}, style_value_types__WEBPACK_IMPORTED_MODULE_1__.number), {
...
function buildTransform(_a, _b, transformIsDefault, transformTemplate) {
  ...
  transformKeys.sort(_transform_mjs__WEBPACK_IMPORTED_MODULE_0__.sortTransformProps); // Track whether the defined transform has a defined z so we don't add a
...
var htmlConfig = {
  ...
  makeTargetAnimatable: function makeTargetAnimatable(element, _a, _b, isMounted) {
    ...
    var transition = _a.transition,
        transitionEnd = _a.transitionEnd,
        target = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__rest)(_a, ["transition", "transitionEnd"]);
...
var visualElement = function visualElement(_a) {
  ...
  return function (_a, options) {
    ...
    var baseTarget = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__assign)({}, latestValues); // Internal methods ========================
...
function buildSVGPath(attrs, length, spacing, offset, useDashCase) {
  ...
  attrs[keys.offset] = style_value_types__WEBPACK_IMPORTED_MODULE_0__.px.transform(-offset); // Build the dash array
...
var variantPriorityOrder = [_types_mjs__WEBPACK_IMPORTED_MODULE_0__.AnimationType.Animate, _types_mjs__WEBPACK_IMPORTED_MODULE_0__.AnimationType.InView, _types_mjs__WEBPACK_IMPORTED_MODULE_0__.AnimationType.Focus, _types_mjs__WEBPACK_IMPORTED_MODULE_0__.AnimationType.Hover, _types_mjs__WEBPACK_IMPORTED_MODULE_0__.AnimationType.Tap, _types_mjs__WEBPACK_IMPORTED_MODULE_0__.AnimationType.Drag, _types_mjs__WEBPACK_IMPORTED_MODULE_0__.AnimationType.Exit];
...
function createAnimationState(visualElement) {
  ...
  var buildResolvedTypeValues = function buildResolvedTypeValues(acc, definition) {
    ...
    if (resolved) {
      ...
      var transitionEnd = resolved.transitionEnd,
          target = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(resolved, ["transition", "transitionEnd"]);
  ...
  function animateChanges(options, changedActiveType) {
    ...
    var _loop_1 = function _loop_1(i) {
      ...
      typeState.protectedKeys = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__assign)({}, encounteredKeys); // Check if we can skip analysing this prop early
...
function animateVariant(visualElement, variant, options) {
  ...
  if (when) {
    var _c = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__read)(when === "beforeChildren" ? [getAnimation, getChildAnimations] : [getChildAnimations, getAnimation], 2),
        first = _c[0],
        last = _c[1];
...
function animateTarget(visualElement, definition, _a) {
  ...
  var _e = visualElement.makeTargetAnimatable(definition),
      ...
      target = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(_e, ["transition", "transitionEnd"]);
...
function setTarget(visualElement, definition) {
  ...
  var target = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__rest)(_a, ["transitionEnd", "transition"]);
...
function moveItem(_a, fromIndex, toIndex) {
  var _b = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__read)(_a),
      arr = _b.slice(0);
  ...
  if (startIndex >= 0 && startIndex < arr.length) {
    ...
    var _c = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__read)(arr.splice(fromIndex, 1), 1),
        item = _c[0];
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.mjs");
/* harmony import */ var popmotion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! popmotion */ "./node_modules/popmotion/dist/es/utils/interpolate.mjs");
...
/* harmony import */ var framesync__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! framesync */ "./node_modules/framesync/dist/es/index.mjs");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _use_constant_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./use-constant.mjs */ "./node_modules/framer-motion/dist/es/utils/use-constant.mjs");
/* harmony import */ var _context_MotionConfigContext_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../context/MotionConfigContext.mjs */ "./node_modules/framer-motion/dist/es/context/MotionConfigContext.mjs");
...
function useAnimationFrame(callback) {
  var initialTimestamp = (0,_use_constant_mjs__WEBPACK_IMPORTED_MODULE_2__.useConstant)(getCurrentTime);
  var isStatic = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(_context_MotionConfigContext_mjs__WEBPACK_IMPORTED_MODULE_3__.MotionConfigContext).isStatic;
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    if (isStatic) return;
    ...
    framesync__WEBPACK_IMPORTED_MODULE_0__.default.update(provideTimeSinceStart, true);
    return function () {
      return framesync__WEBPACK_IMPORTED_MODULE_0__.cancelSync.update(provideTimeSinceStart);
    };
  }, [callback]);
}
...
function useCycle() {
  ...
  var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__read)((0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(items[index.current]), 2),
      item = _a[0],
      setItem = _a[1];

  return [item, function (next) {
    index.current = typeof next !== "number" ? (0,popmotion__WEBPACK_IMPORTED_MODULE_2__.wrap)(0, items.length, index.current + 1) : next;
...
function useForceUpdate() {
  ...
  var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__read)((0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(0), 2),
...
/* harmony import */ var framesync__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! framesync */ "./node_modules/framesync/dist/es/index.mjs");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _projection_use_instant_layout_transition_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../projection/use-instant-layout-transition.mjs */ "./node_modules/framer-motion/dist/es/projection/use-instant-layout-transition.mjs");
/* harmony import */ var _use_force_update_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./use-force-update.mjs */ "./node_modules/framer-motion/dist/es/utils/use-force-update.mjs");
/* harmony import */ var _use_instant_transition_state_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./use-instant-transition-state.mjs */ "./node_modules/framer-motion/dist/es/utils/use-instant-transition-state.mjs");
...
function useInstantTransition() {
  var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__read)((0,_use_force_update_mjs__WEBPACK_IMPORTED_MODULE_3__.useForceUpdate)(), 2),
      forceUpdate = _a[0],
      forcedRenderCount = _a[1];

  var startInstantLayoutTransition = (0,_projection_use_instant_layout_transition_mjs__WEBPACK_IMPORTED_MODULE_4__.useInstantLayoutTransition)();
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    /**
     * Unblock after two animation frames, otherwise this will unblock too soon.
     */
    framesync__WEBPACK_IMPORTED_MODULE_0__.default.postRender(function () {
      return framesync__WEBPACK_IMPORTED_MODULE_0__.default.postRender(function () {
        return _use_instant_transition_state_mjs__WEBPACK_IMPORTED_MODULE_5__.instantAnimationState.current = false;
      });
    });
  }, [forcedRenderCount]);
  return function (callback) {
    startInstantLayoutTransition(function () {
      _use_instant_transition_state_mjs__WEBPACK_IMPORTED_MODULE_5__.instantAnimationState.current = true;
      forceUpdate();
      callback();
    });
  };
...
function useReducedMotion() {
  ...
  var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__read)((0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(prefersReducedMotion.current), 1),
...
function () {
  ...
  function MotionValue(init) {
    ...
    this.updateAndNotify = function (v, render) {
      ...
      var _a = (0,framesync__WEBPACK_IMPORTED_MODULE_0__.getFrameData)(),
          delta = _a.delta,
  ...
  MotionValue.prototype.getVelocity = function () {
    ...
    (0,popmotion__WEBPACK_IMPORTED_MODULE_2__.velocityPerSecond)(parseFloat(this.current) - parseFloat(this.prev), this.timeDelta) : 0;
  };
  /**
...
/* harmony export */ });
/* harmony import */ var _utils_use_constant_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/use-constant.mjs */ "./node_modules/framer-motion/dist/es/utils/use-constant.mjs");
/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils.mjs */ "./node_modules/framer-motion/dist/es/value/scroll/utils.mjs");
/* harmony import */ var _events_use_dom_event_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../events/use-dom-event.mjs */ "./node_modules/framer-motion/dist/es/events/use-dom-event.mjs");
/* harmony import */ var _utils_use_isomorphic_effect_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/use-isomorphic-effect.mjs */ "./node_modules/framer-motion/dist/es/utils/use-isomorphic-effect.mjs");
/* harmony import */ var hey_listen__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! hey-listen */ "./node_modules/hey-listen/dist/hey-listen.es.js");
...
function useElementScroll(ref) {
  var values = (0,_utils_use_constant_mjs__WEBPACK_IMPORTED_MODULE_1__.useConstant)(_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.createScrollMotionValues);
  (0,_utils_use_isomorphic_effect_mjs__WEBPACK_IMPORTED_MODULE_3__.useIsomorphicLayoutEffect)(function () {
    ...
    if (!element) return;
    var updateScrollValues = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.createScrollUpdater)(values, getElementScrollOffsets(element));
    var scrollListener = (0,_events_use_dom_event_mjs__WEBPACK_IMPORTED_MODULE_4__.addDomEvent)(element, "scroll", updateScrollValues, {
      passive: true
    });
    var resizeListener = (0,_events_use_dom_event_mjs__WEBPACK_IMPORTED_MODULE_4__.addDomEvent)(element, "resize", updateScrollValues);
    return function () {
...
/* harmony export */ });
/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils.mjs */ "./node_modules/framer-motion/dist/es/value/scroll/utils.mjs");
/* harmony import */ var _events_use_dom_event_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../events/use-dom-event.mjs */ "./node_modules/framer-motion/dist/es/events/use-dom-event.mjs");
...
function addEventListeners() {
  ...
  (0,_events_use_dom_event_mjs__WEBPACK_IMPORTED_MODULE_1__.addDomEvent)(window, "scroll", updateScrollValues, {
    passive: true
  });
...
function useViewportScroll() {
  ...
  if (!viewportScrollValues) {
    viewportScrollValues = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.createScrollMotionValues)();
  }

  (0,_utils_use_isomorphic_effect_mjs__WEBPACK_IMPORTED_MODULE_2__.useIsomorphicLayoutEffect)(function () {
...
/* harmony export */ });
/* harmony import */ var _use_motion_value_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./use-motion-value.mjs */ "./node_modules/framer-motion/dist/es/value/use-motion-value.mjs");
/* harmony import */ var _use_on_change_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./use-on-change.mjs */ "./node_modules/framer-motion/dist/es/value/use-on-change.mjs");
/* harmony import */ var framesync__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! framesync */ "./node_modules/framesync/dist/es/index.mjs");
...
/* harmony export */ });
/* harmony import */ var _use_transform_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./use-transform.mjs */ "./node_modules/framer-motion/dist/es/value/use-transform.mjs");
/* harmony import */ var hey_listen__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! hey-listen */ "./node_modules/hey-listen/dist/hey-listen.es.js");
/* harmony import */ var _use_motion_value_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./use-motion-value.mjs */ "./node_modules/framer-motion/dist/es/value/use-motion-value.mjs");
/* harmony import */ var _context_MotionContext_index_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../context/MotionContext/index.mjs */ "./node_modules/framer-motion/dist/es/context/MotionContext/index.mjs");
...
function useInvertedScale(scale) {
  var parentScaleX = (0,_use_motion_value_mjs__WEBPACK_IMPORTED_MODULE_1__.useMotionValue)(1);
  var parentScaleY = (0,_use_motion_value_mjs__WEBPACK_IMPORTED_MODULE_1__.useMotionValue)(1);
  var visualElement = (0,_context_MotionContext_index_mjs__WEBPACK_IMPORTED_MODULE_2__.useVisualElementContext)();
  ...
  var scaleX = (0,_use_transform_mjs__WEBPACK_IMPORTED_MODULE_3__.useTransform)(parentScaleX, invertScale);
  var scaleY = (0,_use_transform_mjs__WEBPACK_IMPORTED_MODULE_3__.useTransform)(parentScaleY, invertScale);
  return {
    scaleX: scaleX,
    scaleY: scaleY
  };
...
/* harmony export */ });
/* harmony import */ var _use_combine_values_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./use-combine-values.mjs */ "./node_modules/framer-motion/dist/es/value/use-combine-values.mjs");
...
function useMotionTemplate(fragments) {
  ...
  return (0,_use_combine_values_mjs__WEBPACK_IMPORTED_MODULE_0__.useCombineMotionValues)(values, buildValue);
}
...
function useMotionValue(initial) {
  ...
  if (isStatic) {
    var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__read)((0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(initial), 2),
        setLatest_1 = _a[1];
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _utils_is_motion_value_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/is-motion-value.mjs */ "./node_modules/framer-motion/dist/es/value/utils/is-motion-value.mjs");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.mjs");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var popmotion__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! popmotion */ "./node_modules/popmotion/dist/es/animations/index.mjs");
...
/* harmony import */ var _use_on_change_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./use-on-change.mjs */ "./node_modules/framer-motion/dist/es/value/use-on-change.mjs");
/* harmony import */ var _context_MotionConfigContext_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../context/MotionConfigContext.mjs */ "./node_modules/framer-motion/dist/es/context/MotionConfigContext.mjs");
...
function useSpring(source, config) {
  ...
  var isStatic = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_context_MotionConfigContext_mjs__WEBPACK_IMPORTED_MODULE_1__.MotionConfigContext).isStatic;
  var activeSpringAnimation = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  var value = (0,_use_motion_value_mjs__WEBPACK_IMPORTED_MODULE_2__.useMotionValue)((0,_utils_is_motion_value_mjs__WEBPACK_IMPORTED_MODULE_3__.isMotionValue)(source) ? source.get() : source);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(function () {
    return value.attach(function (v, set) {
      ...
      activeSpringAnimation.current = (0,popmotion__WEBPACK_IMPORTED_MODULE_4__.animate)((0,tslib__WEBPACK_IMPORTED_MODULE_5__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_5__.__assign)({
        from: value.get(),
        to: v,
        velocity: value.getVelocity()
      }, config), {
  ...
  (0,_use_on_change_mjs__WEBPACK_IMPORTED_MODULE_6__.useOnChange)(source, function (v) {
...
/* harmony export */ });
/* harmony import */ var _utils_use_animation_frame_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/use-animation-frame.mjs */ "./node_modules/framer-motion/dist/es/utils/use-animation-frame.mjs");
...
function useTime() {
  var time = (0,_use_motion_value_mjs__WEBPACK_IMPORTED_MODULE_0__.useMotionValue)(0);
  (0,_utils_use_animation_frame_mjs__WEBPACK_IMPORTED_MODULE_1__.useAnimationFrame)(function (t) {
    return time.set(t);
  });
  return time;
}
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.mjs");
/* harmony import */ var _utils_transform_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/transform.mjs */ "./node_modules/framer-motion/dist/es/utils/transform.mjs");
...
function useVelocity(value) {
  var velocity = (0,_use_motion_value_mjs__WEBPACK_IMPORTED_MODULE_1__.useMotionValue)(value.getVelocity());
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
...
var steps = stepsOrder.reduce(function (acc, key) {
  acc[key] = (0,_create_render_step_mjs__WEBPACK_IMPORTED_MODULE_1__.createRenderStep)(function () {
...
function defaultEasing(values, easing) {
  return values.map(function () {
    return easing || _easing_index_mjs__WEBPACK_IMPORTED_MODULE_0__.easeInOut;
...
function getSpringOptions(options) {
  ...
  if (!isSpringType(options, physicsKeys) && isSpringType(options, durationKeys)) {
    var derived = (0,_utils_find_spring_mjs__WEBPACK_IMPORTED_MODULE_0__.findSpring)(options);
...
function spring(_a) {
  var _a$from = _a.from,
      ...
      options = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(_a, ["from", "to", "restSpeed", "restDelta"]);
  ...
  function createSpring() {
    ...
    if (dampingRatio < 1) {
      var angularFreq = (0,_utils_find_spring_mjs__WEBPACK_IMPORTED_MODULE_0__.calcAngularFreq)(undampedAngularFreq, dampingRatio);
...
var framesync = function framesync(update) {
  ...
  return {
    start: function start() {
      return framesync__WEBPACK_IMPORTED_MODULE_0__.default.update(passTimestamp, true);
    },
    stop: function stop() {
      return framesync__WEBPACK_IMPORTED_MODULE_0__.cancelSync.update(passTimestamp);
    }
  };
};
...
function animate(_a) {
  ...
  var from = _a.from,
      ...
      options = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__rest)(_a, ["from", "autoplay", "driver", "elapsed", "repeat", "repeatType", "repeatDelay", "onPlay", "onStop", "onComplete", "onRepeat", "onUpdate"]);
  ...
  var animator = (0,_utils_detect_animation_from_options_mjs__WEBPACK_IMPORTED_MODULE_2__.detectAnimationFromOptions)(options);
...
function inertia(_ref) {
  ...
  function startAnimation(options) {
    ...
    currentAnimation = (0,_index_mjs__WEBPACK_IMPORTED_MODULE_1__.animate)(Object.assign(Object.assign({}, options), {
      driver: driver,
      onUpdate: function onUpdate(v) {
        var _a;
...
var types = {
  keyframes: _generators_keyframes_mjs__WEBPACK_IMPORTED_MODULE_0__.keyframes,
  spring: _generators_spring_mjs__WEBPACK_IMPORTED_MODULE_1__.spring,
  decay: _generators_decay_mjs__WEBPACK_IMPORTED_MODULE_2__.decay
};
...
function cubicBezier(mX1, mY1, mX2, mY2) {
  if (mX1 === mY1 && mX2 === mY2) return _index_mjs__WEBPACK_IMPORTED_MODULE_0__.linear;
...
var easeIn = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.createExpoIn)(2);
var easeOut = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.reverseEasing)(easeIn);
var easeInOut = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.mirrorEasing)(easeIn);

var circIn = function circIn(p) {
  return 1 - Math.sin(Math.acos(p));
};

var circOut = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.reverseEasing)(circIn);
var circInOut = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.mirrorEasing)(circOut);
var backIn = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.createBackIn)(DEFAULT_OVERSHOOT_STRENGTH);
var backOut = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.reverseEasing)(backIn);
var backInOut = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.mirrorEasing)(backIn);
var anticipate = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.createAnticipate)(DEFAULT_OVERSHOOT_STRENGTH);
var ca = 4356.0 / 361.0;
...
var bounceIn = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.reverseEasing)(bounceOut);
...
function distance(a, b) {
  if ((0,_inc_mjs__WEBPACK_IMPORTED_MODULE_0__.isNum)(a) && (0,_inc_mjs__WEBPACK_IMPORTED_MODULE_0__.isNum)(b)) {
    ...
    var zDelta = (0,_is_point_3d_mjs__WEBPACK_IMPORTED_MODULE_2__.isPoint3D)(a) && (0,_is_point_3d_mjs__WEBPACK_IMPORTED_MODULE_2__.isPoint3D)(b) ? distance1D(a.z, b.z) : 0;
...
/* harmony export */ });
/* harmony import */ var _Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/esm/slicedToArray.js */ "./node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/esm/slicedToArray.js");
/* harmony import */ var _progress_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./progress.mjs */ "./node_modules/popmotion/dist/es/utils/progress.mjs");
...
/* harmony import */ var _mix_complex_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./mix-complex.mjs */ "./node_modules/popmotion/dist/es/utils/mix-complex.mjs");
...
/* harmony import */ var _clamp_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./clamp.mjs */ "./node_modules/popmotion/dist/es/utils/clamp.mjs");
...
var mixNumber = function mixNumber(from, to) {
  return function (p) {
    return (0,_mix_mjs__WEBPACK_IMPORTED_MODULE_2__.mix)(from, to, p);
  };
};
...
function detectMixerFactory(v) {
  if (typeof v === 'number') {
    ...
    if (style_value_types__WEBPACK_IMPORTED_MODULE_3__.color.test(v)) {
      return _mix_color_mjs__WEBPACK_IMPORTED_MODULE_4__.mixColor;
    } else {
      return _mix_complex_mjs__WEBPACK_IMPORTED_MODULE_5__.mixComplex;
    }
  } else if (Array.isArray(v)) {
    return _mix_complex_mjs__WEBPACK_IMPORTED_MODULE_5__.mixArray;
  } else if (typeof v === 'object') {
    return _mix_complex_mjs__WEBPACK_IMPORTED_MODULE_5__.mixObject;
  }
}
...
function createMixers(output, ease, customMixer) {
  ...
  for (var i = 0; i < numMixers; i++) {
    ...
    if (ease) {
      ...
      mixer = (0,_pipe_mjs__WEBPACK_IMPORTED_MODULE_6__.pipe)(easingFunction, mixer);
    }
...
function fastInterpolate(_ref, _ref2) {
  var _ref3 = (0,_Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_0__.default)(_ref, 2),
      from = _ref3[0],
      to = _ref3[1];

  var _ref4 = (0,_Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_0__.default)(_ref2, 1),
      mixer = _ref4[0];

  return function (v) {
    return mixer((0,_progress_mjs__WEBPACK_IMPORTED_MODULE_7__.progress)(from, to, v));
  };
}
...
function slowInterpolate(input, mixers) {
  ...
  return function (v) {
    ...
    var progressInRange = (0,_progress_mjs__WEBPACK_IMPORTED_MODULE_7__.progress)(input[mixerIndex], input[mixerIndex + 1], v);
...
function interpolate(input, output) {
  ...
  return isClamp ? function (v) {
    return interpolator((0,_clamp_mjs__WEBPACK_IMPORTED_MODULE_8__.clamp)(input[0], input[inputLength - 1], v));
  } : interpolator;
}
...
var isPoint3D = function isPoint3D(point) {
  return (0,_is_point_mjs__WEBPACK_IMPORTED_MODULE_0__.isPoint)(point) && point.hasOwnProperty('z');
};
...
/* harmony export */ });
/* harmony import */ var _Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/esm/toConsumableArray.js */ "./node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/esm/toConsumableArray.js");
/* harmony import */ var style_value_types__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! style-value-types */ "./node_modules/style-value-types/dist/es/color/index.mjs");
...
/* harmony import */ var _mix_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./mix.mjs */ "./node_modules/popmotion/dist/es/utils/mix.mjs");
/* harmony import */ var _mix_color_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./mix-color.mjs */ "./node_modules/popmotion/dist/es/utils/mix-color.mjs");
/* harmony import */ var _inc_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./inc.mjs */ "./node_modules/popmotion/dist/es/utils/inc.mjs");
/* harmony import */ var _pipe_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./pipe.mjs */ "./node_modules/popmotion/dist/es/utils/pipe.mjs");
/* harmony import */ var hey_listen__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! hey-listen */ "./node_modules/hey-listen/dist/hey-listen.es.js");
...
function getMixer(origin, target) {
  if ((0,_inc_mjs__WEBPACK_IMPORTED_MODULE_2__.isNum)(origin)) {
    return function (v) {
      return (0,_mix_mjs__WEBPACK_IMPORTED_MODULE_3__.mix)(origin, target, v);
    };
  } else if (style_value_types__WEBPACK_IMPORTED_MODULE_4__.color.test(origin)) {
    return (0,_mix_color_mjs__WEBPACK_IMPORTED_MODULE_5__.mixColor)(origin, target);
  } else {
...
var mixArray = function mixArray(from, to) {
  var output = (0,_Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__.default)(from);
...
var mixComplex = function mixComplex(origin, target) {
  ...
  if (canInterpolate) {
    return (0,_pipe_mjs__WEBPACK_IMPORTED_MODULE_7__.pipe)(mixArray(originStats.parsed, targetStats.parsed), template);
  } else {
    (0,hey_listen__WEBPACK_IMPORTED_MODULE_1__.warning)(true, "Complex values '".concat(origin, "' and '").concat(target, "' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition."));
    return function (p) {
...
var color = {
  test: function test(v) {
    return _rgba_mjs__WEBPACK_IMPORTED_MODULE_0__.rgba.test(v) || _hex_mjs__WEBPACK_IMPORTED_MODULE_1__.hex.test(v) || _hsla_mjs__WEBPACK_IMPORTED_MODULE_2__.hsla.test(v);
  },
  parse: function parse(v) {
...
var clampRgbUnit = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.clamp)(0, 255);
var rgbUnit = Object.assign(Object.assign({}, _numbers_index_mjs__WEBPACK_IMPORTED_MODULE_1__.number), {
  transform: function transform(v) {
...
var rgba = {
  ...
  transform: function transform(_ref) {
    var red = _ref.red,
        ...
        _ref$alpha = _ref.alpha,
        alpha$1 = _ref$alpha === void 0 ? 1 : _ref$alpha;
    return 'rgba(' + rgbUnit.transform(red) + ', ' + rgbUnit.transform(green) + ', ' + rgbUnit.transform(blue) + ', ' + (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.sanitize)(_numbers_index_mjs__WEBPACK_IMPORTED_MODULE_1__.alpha.transform(alpha$1)) + ')';
  }
};
...
/* harmony export */ });
/* harmony import */ var _Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/esm/defineProperty.js */ "./node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/esm/defineProperty.js");
/* harmony import */ var _Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/esm/slicedToArray.js */ "./node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/esm/slicedToArray.js");
/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils.mjs */ "./node_modules/style-value-types/dist/es/utils.mjs");
...
var isColorString = function isColorString(type, testProp) {
  return function (v) {
    return Boolean((0,_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.isString)(v) && _utils_mjs__WEBPACK_IMPORTED_MODULE_2__.singleColorRegex.test(v) && v.startsWith(type) || testProp && Object.prototype.hasOwnProperty.call(v, testProp));
  };
};
...
var splitColor = function splitColor(aName, bName, cName) {
  return function (v) {
    ...
    if (!(0,_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.isString)(v)) return v;

    var _v$match = v.match(_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.floatRegex),
        _v$match2 = (0,_Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_1__.default)(_v$match, 4),
        a = _v$match2[0],
        b = _v$match2[1],
        c = _v$match2[2],
        alpha = _v$match2[3];

    return _ref = {}, (0,_Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__.default)(_ref, aName, parseFloat(a)), (0,_Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__.default)(_ref, bName, parseFloat(b)), (0,_Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__.default)(_ref, cName, parseFloat(c)), (0,_Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__.default)(_ref, "alpha", alpha !== undefined ? parseFloat(alpha) : 1), _ref;
  };
};
...
/* harmony export */ });
/* harmony import */ var _Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/esm/slicedToArray.js */ "./node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/esm/slicedToArray.js");
/* harmony import */ var _index_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.mjs */ "./node_modules/style-value-types/dist/es/complex/index.mjs");
/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils.mjs */ "./node_modules/style-value-types/dist/es/utils.mjs");
...
function applyDefaultFilter(v) {
  var _v$slice$split = v.slice(0, -1).split('('),
      _v$slice$split2 = (0,_Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_0__.default)(_v$slice$split, 2),
      name = _v$slice$split2[0],
      value = _v$slice$split2[1];

  if (name === 'drop-shadow') return v;

  var _ref = value.match(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.floatRegex) || [],
      _ref2 = (0,_Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_0__.default)(_ref, 1),
      number = _ref2[0];
...
var filter = Object.assign(Object.assign({}, _index_mjs__WEBPACK_IMPORTED_MODULE_2__.complex), {
...
/* harmony export */ });
/* harmony import */ var _Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/esm/toConsumableArray.js */ "./node_modules/@umijs/babel-preset-umi/node_modules/@babel/runtime/helpers/esm/toConsumableArray.js");
/* harmony import */ var _color_index_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../color/index.mjs */ "./node_modules/style-value-types/dist/es/color/index.mjs");
/* harmony import */ var _numbers_index_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../numbers/index.mjs */ "./node_modules/style-value-types/dist/es/numbers/index.mjs");
/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils.mjs */ "./node_modules/style-value-types/dist/es/utils.mjs");
...
function test(v) {
  ...
  return isNaN(v) && (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.isString)(v) && ((_b = (_a = v.match(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.floatRegex)) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) + ((_d = (_c = v.match(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.colorRegex)) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0 ? _d : 0) > 0;
}
...
function analyse(v) {
  ...
  var values = [];
  var numColors = 0;
  var colors = v.match(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.colorRegex);

  if (colors) {
    numColors = colors.length;
    v = v.replace(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.colorRegex, colorToken);
    values.push.apply(values, (0,_Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__.default)(colors.map(_color_index_mjs__WEBPACK_IMPORTED_MODULE_2__.color.parse)));
  }

  var numbers = v.match(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.floatRegex);

  if (numbers) {
    v = v.replace(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.floatRegex, numberToken);
    values.push.apply(values, (0,_Users_stone_Documents_develop_pcloud_components_node_modules_umijs_babel_preset_umi_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__.default)(numbers.map(_numbers_index_mjs__WEBPACK_IMPORTED_MODULE_3__.number.parse)));
  }
...
function createTransformer(v) {
  ...
  return function (v) {
    ...
    for (var i = 0; i < numValues; i++) {
      output = output.replace(i < numColors ? colorToken : numberToken, i < numColors ? _color_index_mjs__WEBPACK_IMPORTED_MODULE_2__.color.transform(v[i]) : (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.sanitize)(v[i]));
    }
...
var alpha = Object.assign(Object.assign({}, number), {
  transform: (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.clamp)(0, 1)
});
...
var createUnitType = function createUnitType(unit) {
  return {
    test: function test(v) {
      return (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.isString)(v) && v.endsWith(unit) && v.split(' ').length === 1;
    },
    parse: parseFloat,
    transform: function transform(v) {
