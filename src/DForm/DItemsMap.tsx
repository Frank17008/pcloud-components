...
const renderMap = {
  ...
  other: (
    ...
    const placeholder: any = allProps.renderType === 'rangePicker' ? props.placeholder : _placeholder;

    return <Form.Item {...formItemProps}>{render ? render({ placeholder, ...props }, formItemProps, allProps) : children}</Form.Item>;
  },
